...
if success_direct_login_last:
    ...
    print '\t\t"{#LOGIN3}":"SUCCESS DIRECT LOGIN",' +  '\t\t"{#USER}":\"'+"User "+str(cut_success_direct_login_last[11])+"\","+ '\t\t"{#IP}":\"'+"by "+str((cut_success_direct_login_last[13])[6:-2])+"\""
    print "\t},\n"
...
if success_ssh_last:        
    ...
    print "\t{\n"
    print '\t\t"{#LOGIN4}":"SUCCESS SSH",' +  '\t\t"{#USER}":\"'+"User "+str(cut_success_ssh_last[8])+"\","+ '\t\t"{#IP}":\"from '+str(cut_success_ssh_last[10])+" port "+str(cut_success_ssh_last[12])+"\""
    print "\t}\n"
    print "\n\t]\n"
    print "}\n"
